      ...
      <Row>
        ...
        <i-col :xs="24" :sm="12" :xl="8">
          <FormItem  label="行业类型：" >
            <Row>
              <i-col :xs="24" :sm="12">
                <Select v-model="formData.bigClass"  placeholder="请选择大类"  clearable @on-change="selctBigClass">
                  <Option v-for="(value, index) in dataBase.bigClassData" :value="value" :key="index">{{ value }}</Option>
                </Select>
              </i-col>
              <i-col :xs="24" :sm="12">
                <Select v-model="formData.smallClass"  placeholder="请选择小类" clearable>
        ...
        <i-col :xs="24" :sm="12" :xl="8">
          <FormItem  label="投保限额：" >
            <Row>
              <i-col :xs="24" :sm="12">
                <i-Input type="text" v-model="formData.insuredStart"  placeholder="起始限额"   clearable>
                   <span slot="append">至</span>
                </i-Input>
              </i-col>
              <i-col :xs="24" :sm="12">
                <i-Input type="text" v-model="formData.insuredEnd"  placeholder="终止限额"  clearable></i-Input>
              </i-col>
            </Row>
          </FormItem>
        </i-col>
